...
# Criar tabela
cursor.execute("""
CREATE TABLE IF NOT EXISTS tabela_13 (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    potencia_nominal TEXT,
    potencia_kw REAL,
    potencia_kva REAL,
    corrente_nominal_110 REAL,
    corrente_nominal_220 REAL,
    corrente_partida_110 REAL,
...
cursor.executemany("""
INSERT INTO tabela_13 (
potencia_nominal,
potencia_kw,
potencia_kva,
corrente_nominal_110,
corrente_nominal_220,
corrente_partida_110,
...
print("Tabela 13 criada e preenchida com sucesso.")