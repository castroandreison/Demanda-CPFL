...
# Criar tabela
cursor.execute("""
CREATE TABLE IF NOT EXISTS tabela_14 (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    potencia_nominal TEXT,
    potencia_kw REAL,
    potencia_kva REAL,
    corrente_nominal_380 REAL,
    corrente_nominal_220 REAL,
    corrente_partida_380 REAL,
    corrente_partida_220 REAL,
    cos_phi REAL
)
""")
...
cursor.executemany("""
INSERT INTO tabela_14 (
potencia_nominal,
potencia_kw,
potencia_kva,
corrente_nominal_380,
corrente_nominal_220,
corrente_partida_380,
corrente_partida_220,
cos_phi
)
VALUES (?,?,?,?,?,?,?,?)
""", dados)
...
print("Tabela 14 criada e preenchida com sucesso.")